...
export default function () {
  ...
  return (
    ...
    <div style={ckd}>
    <h3 style={ckh}>Enter Recommendation which you received from your senior</h3>
    <input type="text" name="Skill" value={user.name} style ={csl} placeholder=" Recommendation " onChange={ handleChange }  ></input> <br /><br />
